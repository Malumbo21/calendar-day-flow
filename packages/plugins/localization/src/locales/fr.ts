...
const fr: DayflowLocale = {
  ...
  messages: {
    ...
    meetingUrlPlaceholder: 'Coller un lien de réunion...',
    invalidMeetingUrl: 'Saisissez une URL http:// ou https:// valide.',
    editMeetingUrl: 'Modifier l’URL de la réunion',
    join: 'Rejoindre',
    ...
    deleteGroupTitle: 'Supprimer {groupName} ?',
    deleteGroupMessage:
      'La suppression de ce groupe supprimera tous ses calendriers ({calendarCount} au total). Cette action est irréversible.',
    groupName: 'Nom du groupe',
    groupNamePlaceholder: 'p. ex. Travail',
    groupNameExists: 'Un groupe portant ce nom existe déjà.',
    merge: 'Fusionner',
    confirmDeleteTitle:
    ...
    repeat: 'Répéter',
    doesNotRepeat: 'Aucune répétition',
    everyDay: 'Tous les jours',
    everyWeek: 'Toutes les semaines',
    everyMonth: 'Tous les mois',
    everyYear: 'Tous les ans',
    custom: 'Personnalisé',
    endRepeat: 'Fin de la répétition',
    never: 'Jamais',
    onDate: 'À une date',
    after: 'Après',
    occurrences: 'occurrences',
    every: 'Tous les',
    customRepeat: 'Répétition personnalisée',
    frequency: 'Fréquence',
    daily: 'Quotidienne',
    weekly: 'Hebdomadaire',
    monthly: 'Mensuelle',
