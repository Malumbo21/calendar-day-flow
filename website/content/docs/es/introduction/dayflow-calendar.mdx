...
- Al añadir `createSidebarPlugin()` a los plugins se renderiza la barra lateral predeterminada (`DefaultCalendarSidebar`), con filtros de calendario, controles para mostrar u ocultar todos y funciones para crear, editar, eliminar y reordenar grupos.
