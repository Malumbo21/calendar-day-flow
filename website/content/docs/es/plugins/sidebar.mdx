...
| `groups`                     | `string[]`                                                     | `[]`                               | Restaura los nombres y el orden de los grupos                |
| `onGroupCreate`              | `(groupName: string) => void \| Promise<void>`                 | `undefined`                        | Callback al crear un grupo                                   |
| `onGroupRename`              | `(previousName, nextName, calendars) => void \| Promise<void>` | `undefined`                        | Callback al cambiar el nombre de un grupo                    |
| `onGroupDelete`              | `(groupName, calendars) => void \| Promise<void>`              | `undefined`                        | Callback al eliminar un grupo                                |
| `onGroupReorder`             | `(groups: string[]) => void \| Promise<void>`                  | `undefined`                        | Callback al cambiar el orden de los grupos                   |
...
Los callbacks de grupo se esperan antes de aplicar el cambio. Si un Promise se rechaza, el grupo o su orden no se modifica y los diálogos de edición permanecen abiertos. El argumento `calendars` contiene los calendarios asignados actualmente; `onGroupReorder` recibe la lista completa y ordenada de nombres de grupo.
...
- **Grupos de calendarios**: haz clic derecho en la barra lateral para crear un grupo; haz clic derecho en un grupo para renombrarlo, eliminarlo tras una confirmación o crear un calendario dentro de él.
- **Reordenar grupos**: arrastra los encabezados de grupo para cambiar su orden. Usa `groups` para restaurar el orden guardado y `onGroupReorder` para persistir los cambios.
