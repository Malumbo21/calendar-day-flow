...
Starting with the style refactor, the shared DayFlow foundation CSS is the single source of truth for theme tokens, component primitives, and semantic helper classes such as `df-fill-primary` and `df-focus-ring`.
