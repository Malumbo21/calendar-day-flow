...
DayFlow's distributed CSS is now self-contained. You do **not** need to add `@source` entries, safelists, or extra UnoCSS/Tailwind scanning rules for DayFlow itself.
